              ...
              {selectedMonth && (
                <g>
                  <path
                    id="jan"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("1") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="feb"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("2") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="mar"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("3") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="apr"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("4") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="may"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("5") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="jun"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("6") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="jul"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("7") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="aug"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("8") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
                  ...
                  <path
                    id="sep"
                    onClick={() =>
                      selectedMonth ? setSelectedMonth("9") : null
                    }
                    fill="none"
                    style={{
                      pointerEvents: "none",
